...
if(mysqli_num_rows($sql) > 0)
					{
						while($row = mysqli_fetch_array($sql))
						{
								...
								$_SESSION['phone'] = $row["telephone_no"];
...
include './auth.php';
mysqli_query($dbhandle,"INSERT INTO booking (booking_id, total_adult, total_children, checkin_date, checkout_date, special_requirement, payment_status, total_amount, deposit, first_name, last_name, email, telephone_no, add_line1, add_line2, city, state, postcode, country,admin_id) 
...
mysqli_query($dbhandle,"INSERT INTO `roombook` (`booking_id`, `room_id`, `totalroombook`, `id`,`admin_id`) VALUES ('".$_SESSION['booking_id']."', '".$value0."', '".$_SESSION['roomqty'][$count]."', NULL,'".$_SESSION['admin_id']."');");
$count = $count+1;
} ;
...
$message .="													<br><b>";
$message .="                     <form action=\"reservationcomplete.php\" method=\"post\" target=\"_top\">\n";
